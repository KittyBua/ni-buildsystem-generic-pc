...
#
sudo apt-get install build-essential ccache git make subversion patch gcc bison flex texinfo automake libtool ncurses-dev pkg-config libtool-bin autoconf libavformat-dev libswscale-dev libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev libswresample-dev libglew-dev freeglut3-dev libao-dev libid3tag0-dev libmad0-dev libogg-dev libfreetype6-dev libsigc++-2.0-dev libcurl4-openssl-dev libreadline6-dev libflac-dev 
libvorbis-dev libjpeg-dev libgif-dev libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev
#
sudo apt update 
#
sudo apt upgrade
